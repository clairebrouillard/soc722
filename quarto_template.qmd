...
![This is a picture of my dog, Quinn. She has crooked teeth.](images/quinn.jpeg){#fig-quinn fig-align="center" width="75%" length="75%"}
...
It's also easy to cross-reference equations. For example, @eq-1 depicts the *normal distribution.*
